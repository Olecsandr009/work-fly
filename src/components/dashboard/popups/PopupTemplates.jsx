    ...
    return (
        <form data-burger="8" action="#" className="more-item-burger">
            ...
            <div data-form-radio-group="21" className="more-item-burger__content-center">
                ...
                <label for="input-search" className="more-item-burger__label-search">
                ...
                <label data-label-radio="21" for="template-radio1" className="more-item-burger__label">
                ...
                <label data-label-radio="21" for="template-radio2" className="more-item-burger__label">
                ...
                <label data-label-radio="21" for="template-radio3" className="more-item-burger__label">
